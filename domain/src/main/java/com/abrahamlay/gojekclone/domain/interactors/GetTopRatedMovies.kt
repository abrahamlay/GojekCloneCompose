...
) : com.abrahamlay.gojekclone.domain.FlowableUseCase<List<com.abrahamlay.gojekclone.domain.entities.MovieModel>?, GetTopRatedMovies.Params>(postExecutionThread) {
